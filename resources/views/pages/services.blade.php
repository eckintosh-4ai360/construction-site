...
@section('title', 'SNODA Construction Services - Professional Building Solutions')
@section('description', 'Comprehensive construction services including new construction, renovations, project management, design, and specialized solutions.')
@section('keywords', 'construction services, building, renovation, project management')
