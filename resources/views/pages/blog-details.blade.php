...
@section('title', 'Blog - Construction Insights | SNODA Construction')
@section('description', 'Read our latest construction articles and industry insights from SNODA Construction blog.')
@section('keywords', 'construction blog, articles, industry news')
